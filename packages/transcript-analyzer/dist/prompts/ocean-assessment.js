...
exports.FACET_NAMES = exports.OCEAN_SYSTEM_PROMPT = void 0;
exports.buildTranscriptAnalysisPrompt = buildTranscriptAnalysisPrompt;
exports.OCEAN_SYSTEM_PROMPT = `You are an expert industrial-organizational psychologist specializing in Big Five (OCEAN) personality assessment from interview transcripts.
...
`;
function buildTranscriptAnalysisPrompt(transcript, context) {
