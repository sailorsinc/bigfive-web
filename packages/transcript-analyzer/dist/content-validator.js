...
exports.shouldProceedWithAnalysis = shouldProceedWithAnalysis;
exports.getQualityScore = getQualityScore;
function assessContentQuality(transcript) {
    const warnings = [];
...
function shouldProceedWithAnalysis(quality) {
