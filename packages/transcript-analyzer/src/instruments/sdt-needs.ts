...
export interface SdtNeed {
  key: SdtNeedKey
  title: string
  // What the need is about, in the interviewer's plain words (drives the prompt)
  about: string
  high: string
  low: string
}
...
export const SDT_ITEMS: SdtItem[] = [
  // Autonomy
...
export const SDT_ITEM_IDS = SDT_ITEMS.map(i => String(i.id))
